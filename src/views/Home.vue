        ...
        <div class="flex justify-between items-center max-w-7xl mx-auto px-4 py-6 sm:px-6 md:justify-start md:space-x-10 lg:px-8">
          <div class="flex justify-start lg:w-0 lg:flex-1">
            <router-link to="/" class="flex items-center">
              <span class="sr-only">Refactoring</span>
              <img class="h-10 w-auto sm:h-10" src="../assets/logo-removebg-preview.png" alt="" />
              <h2 class="text-indigo-700 text-lg font-bold">Refactoring</h2>
            </router-link>
          </div>
          ...
          <PopoverGroup as="nav" class="hidden md:flex space-x-10">
            ...
            <router-link to="/price" class="text-base font-medium text-gray-500 hover:text-gray-900">Цены</router-link>
          ...
          <div class="hidden md:flex items-center justify-end md:flex-1 lg:w-0 space-x-4">
            <router-link to="/login" class="btn-gradient">Sign in</router-link>
           <router-link to="/reg" class="btn-gradient">Sign up</router-link>
          </div>
        </div>
            ...
            <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
              ...
              <div class="py-6 px-5">
                <div class="grid grid-cols-2 gap-4">
                  <router-link to="/price" class="text-base font-medium text-gray-900 hover:text-gray-700">
                    Pricing
                  </router-link>
          ...
          <div class="relative shadow-xl sm:rounded-2xl sm:overflow-hidden">
            ...
            <div class="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
              <h1 class="text-center text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl">
                <span class="block text-white">Команда професионалов которая</span>
                <span class="block text-indigo-200">поднимет ваш бизнес</span>
              </h1>
              <p class="mt-6 max-w-lg mx-auto text-center text-xl text-indigo-200 sm:max-w-3xl">
              На рынке разработки различных веб-приложений более 5 лет, от простого лендинга до сложных CRM систем
              </p>
      ...
      <div class="bg-gray-100">
        <div class="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
          <p class="text-center text-sm font-semibold uppercase text-gray-500 tracking-wide">
            Инструметы с которыми мы работаем
          </p>
          <div class="mt-6 grid grid-cols-2 gap-8 md:grid-cols-4 lg:grid-cols-4 flex items-center">
           ...
           <div class="col-span-1 flex justify-center md:col-span-2 lg:col-span-1">
              <img class="h-16 w-auto" src="../assets/vercel.png" />
            </div>
          </div>
        </div>
      </div>
              ...
              <div>
                ...
                <div class="mt-6">
                  <h2 class="text-3xl font-extrabold tracking-tight text-gray-900">
                   Будьте в курсе поддержки клиентов
                  </h2>
                  <p class="mt-4 text-lg text-gray-500">
                            Будьте на связи с вашими клиентами, моментально получайте заявки от клиентов, с комфортом для вас.
                  </p>
                  <div class="mt-6">
                ...
                <blockquote>
                  <div>
                    <p class="text-base text-gray-500">
                      &ldquo;Благодаря Inbox App контактировать с клиентами стало намного проще и удобнее&rdquo;
                    </p>
                  </div>
                  <footer class="mt-3">
          ...
          <div class="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:grid-flow-col-dense lg:gap-24">
            <div class="px-4 max-w-xl mx-auto sm:px-6 lg:py-32 lg:max-w-none lg:mx-0 lg:px-0 lg:col-start-2">
              <div>
                ...
                <div class="mt-6">
                  <h2 class="text-3xl font-extrabold tracking-tight text-gray-900">
                   Пойми лучше - чего хочет клиент
                  </h2>
                  <p class="mt-4 text-lg text-gray-500">
                Благодаря хорошо продуманной системе UX взаимосвязь с клиентом будет максимально эффективной и качественной, и ваша продуктивность будет расти вверх
                  </p>
                  <div class="mt-6">
                    <a href="#" class="inline-flex bg-gradient-to-r from-purple-600 to-indigo-600 bg-origin-border px-4 py-2 border border-transparent text-base font-medium rounded-md shadow-sm text-white hover:from-purple-700 hover:to-indigo-700">
                    Написать нам
      ...
      <div class="relative bg-gray-900">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8 xl:grid xl:grid-cols-2 xl:grid-flow-col-dense xl:gap-x-8">
          <div class="relative pt-12 pb-64 sm:pt-24 sm:pb-64 xl:col-start-1 xl:pb-24">
            <p class="mt-3 text-3xl font-extrabold text-white">О нас</p>
            <p class="mt-5 text-lg text-gray-300">На протяжении 5 лет мы держим высокую планку качества наших проектов</p>
      ...
      <div class="bg-white">
        <div class="max-w-4xl mx-auto py-16 px-4 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8 lg:flex lg:items-center lg:justify-between">
          <h2 class="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">
            <span class="block">Готовы прокачать ваш бизнес?</span>
            <span class="block bg-gradient-to-r from-purple-600 to-indigo-600 bg-clip-text text-transparent">Регистрируйтесь и оставляйте заявку!</span>
          </h2>
    ...
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
      ...
      <div class="mt-8 md:mt-0 md:order-1">
        <p class="text-center text-base text-gray-400">
          &copy; 2021 Refactor, Inc. All rights reserved.
        </p>
      </div>
    </div>
  </footer>
...
import { AnnotationIcon, ChatAlt2Icon, ChatAltIcon, DocumentReportIcon,HeartIcon, InboxIcon, MenuIcon,PencilAltIcon, QuestionMarkCircleIcon,ReplyIcon,SparklesIcon,TrashIcon,UsersIcon, XIcon,} from '@heroicons/vue/outline'
  const metrics = [
      { id: 1, stat: '>500', emphasis: 'Компаний', rest: 'пользуются нашими продуктами' },
      { id: 2, stat: '>10', emphasis: 'Стран', rest: 'с которыми мы сотрудничаем' },
      { id: 3, stat: '>500', emphasis: 'Положительных', rest: 'отзывов' },
      { id: 4, stat: '>1M', emphasis: 'Людей', rest: 'посещают наши проекты каждый день' },
    ]
const solutions = [
    {
      name: 'Неограниченные возможности',
      description: 'Общение с клиентами без ограничений',
      href: '#',
      icon: InboxIcon,
    },
    {
...
const features = [
  ...
  {
    name: 'Управляйте сотрудниками',
    description: 'Корректируйте действия своих сотрудников в зависимости от желаний клиента',
    icon: UsersIcon,
  },
  {
    name: 'Сохранение важного',
    description: 'Сохраните важные пожелания клиента, чтобы ничего не забыть',
    icon: TrashIcon,
  },
  {
    name: 'Получайте объективную оценку',
    description: 'Оценка клиента мотивирует быть лучше',
    icon: PencilAltIcon,
  },
